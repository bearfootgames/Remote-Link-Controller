...
public class TelloVideoTexture : MonoBehaviour {
	...
	void Awake()
	{
		if(networkhandler == null){
			...
			Debug.Log("TellVideoTexture found networkhandler");
		}
	}

	public UnityEngine.UI.Toggle showVideo;

	public void SortData(byte[] data)
	{
		//show data
		if(showVideo.isOn)
		{
		...
		//send data to server
		if(networkhandler.isClient && !networkhandler.isServer)
		{
			//send data to server
			if(client == null){
