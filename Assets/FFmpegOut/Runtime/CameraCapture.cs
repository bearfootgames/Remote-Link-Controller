...
namespace FFmpegOut
{
    ...
    public sealed class CameraCapture : MonoBehaviour
    {
        ...
        public void video_disable()
        {
           ...
           Message.text = "Saved as :"+videoname;
        }
        Text Message;
        IEnumerator Start()
        { 
        ...
        void Awake()
        {
            ...
            if(!recordbutton){
                recordbutton = GameObject.Find("Button_RecordVideo").transform.Find("Text").GetComponent<Text>();
            }
        }

        public void video_handler()
        {
            // Lazy initialization
            if (_session == null)
            {
